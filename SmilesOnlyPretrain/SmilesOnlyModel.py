...
class SmilesOnlyModel(RobertaPreTrainedModel):
...
class SmilesOnlyModelForMaskedLM(RobertaPreTrainedModel):
    """
    MLM任务
    """
    ...
    def __init__(self, config):
        ...
        self.roberta = SmilesOnlyModel(config)
...
# 扩展配置
class SmilesOnlyModelConfig(RobertaConfig):
    model_type = "Onlymodel-smiles"

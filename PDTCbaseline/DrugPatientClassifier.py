...
from PDTCbaseline.EvenLayerTransformerPatientEncoder import EvenLayerTransformerPatientEncoder
from PretrainModel.MultiSmilesModel import MultiSmilesModelConfig, MultiSmilesModel


class DrugPatientClassifier(nn.Module):
    def __init__(self, drug_model_path, patient_encoding_dim, num_classes=4, num_layer=4,
        ...
        self.patient_encoder = EvenLayerTransformerPatientEncoder(
